...
[Find](https://github.com/nholuongut/dify/issues?q=is:issue+is:open) an existing issue, or [open](https://github.com/nholuongut/dify/issues/new/choose) a new one. We categorize issues into 2 types:
...
* If you want to pick one up from the existing issues, simply drop a comment below it saying so.
  ...
  | Popular feature requests from our [community feedback board](https://github.com/nholuongut/dify/discussions/categories/feedbacks) | Medium Priority |
...
If you are adding a model provider, [this guide](https://github.com/nholuongut/dify/blob/main/api/core/model_runtime/README.md) is for you.
...
And that's it! Once your PR is merged, you will be featured as a contributor in our [README](https://github.com/nholuongut/dify/blob/main/README.md).
