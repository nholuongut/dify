...
[查找](https://github.com/nholuongut/dify/issues?q=is:issue+is:open)现有问题，或 [创建](https://github.com/nholuongut/dify/issues/new/choose) 一个新问题。我们将问题分为两类：
...
根据所提议的功能所属的领域不同，您可能需要与不同的团队成员交流。以下是我们团队成员目前正在从事的各个领域的概述：
  ...
  | 在 [community feedback board](https://github.com/nholuongut/dify/discussions/categories/feedbacks) 内反馈的常见功能请求 | 中等优先级 |
  | 非核心功能和小幅改进                     | 低优先级    |
  | 有价值但不紧急                                   | 未来功能  |
...
如果您要添加模型提供程序，请参考 [此指南](https://github.com/nholuongut/dify/blob/main/api/core/model_runtime/README.md)。
...
就是这样！一旦你的 PR 被合并，你将成为我们 [README](https://github.com/nholuongut/dify/blob/main/README.md) 中的贡献者。
