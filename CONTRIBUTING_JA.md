...
[既存の Issue](https://github.com/nholuongut/dify/issues?q=is:issue+is:open) を探すか、[新しい Issue](https://github.com/nholuongut/dify/issues/new/choose) を作成してください。私たちは Issue を 2 つのタイプに分類しています。
...
| [community feedback board](https://github.com/nholuongut/dify/discussions/categories/feedbacks)の人気の機能リクエスト | Medium Priority |
...
モデルプロバイダーを追加する場合は、[このガイド](https://github.com/nholuongut/dify/blob/main/api/core/model_runtime/README.md)が役立ちます。
...
これで完了です！あなた様の PR がマージされると、[README](https://github.com/nholuongut/dify/blob/main/README.md) にコントリビューターとして紹介されます。
